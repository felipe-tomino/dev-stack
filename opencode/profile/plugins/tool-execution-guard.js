	...
	return {
		...
		properties: {
			command: {
				type: "string",
				minLength: 1,
				description: "One complete shell command without placeholders.",
			},
			directory: {
				type: "string",
				enum: [...APPROVED_DIRECTORY_ALIASES],
				default: "workspace",
...
export function createToolExecutionGuard({
	...
	return {
		"tool.definition": async (input, output) => {
			...
			output.parameters = bashToolParameters();
		},
